...
#         '2index.flv',
#         '-f', 'rtsp',
#         'rtmp://media5.ambicam.com:1938/live/abc'
#     ]
#     return subprocess.Popen(ffmpg_cmd, stdin=subprocess.PIPE)
pushurl = "rtmp://media.torqueai.io:1938/live/yotest1"
...
def run(
    ...
    if webcam:
        ...
        ffmpeg_process = run_ffmpeg( 640,352, 1)
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'links.txt', help='file/dir/URL/glob, 0 for webcam')
